...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="./assets/Productos/1.jpg" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                <h5 class="font-baloo font-size-20">Producto 1</h5>
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>Precio Oferta:</td>
                        <td class="font-size-20 text-danger">S/<span>17.00</span><small class="text-dark font-size-12">&nbsp;&nbsp;Incluido I.G.V.</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Ahorro:</td>
