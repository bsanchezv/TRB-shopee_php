                        ...
                        <div class="panel panel-defaul">
                            <div class="panel-heading">
                                ...
                                <div class="pull-right">
                                    <a href="editar_perfil.php"><button type="button" class="btn btn-warning">EDITAR PERFIL</button></a>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="text-center">
                                    <form action="#" method="post" enctype="multipart/form-data" id="reg-form">
                                        ...
                                        <div class="form-row my-4">
                                            <div class="col">
                                                <img src="assets/admin.png" width="300" ><br>
                                            </div>
                                        </div>
                                        <!--nombres administrador-->
                                        <div class="form-row my-4"> <!--margen y=4-->
                                            <div class="col">
                                                <label for="Grupo de Nombre">Nombre: D'angelo Catacora Mamani</label>
                                            </div>
                                        </div>
                                        <!--Fecha Nacimiento-->
                                        <div class="form-row my-4">
                                            <div class="col">
                                                <label for="Grupo de Nombre">Fecha Nacimiento: 30/03/1997</label><br>
                                        ...
                                        <div class="form-row my-4"> <!--margen y=4-->
                                            <div class="col">
                                                <label for="Grupo de Nombre">Email: dangelo_123456@gmail.com</label>
                                            </div>
                                        </div>
